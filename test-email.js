...
async function sendTestEmail() {
  ...
  try {
    const info = await transporter.sendMail({
      ...
      subject: '🧪 Test Email - CODE 4O4 Dev Club',
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
          ...
          <div class="content">
            ...
            <p>This is a test email from the CODE 4O4 Dev Club credential system.</p>
...
This is a test email from the CODE 4O4 Dev Club credential system.
